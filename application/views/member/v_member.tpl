...
<div class="row clear_fix">
    <div class="col-md-12">
        ...
        <div class="well">
            <form class="form-inline" role="form" id="frmadd" action="{base_url('adminarea/admin/create')}" method="POST">
...
$(document).ready(function (){
    ...
    function fillgrid(){
        $("#loader").show();
        $.ajax({
            url:'<?php echo base_url() ?>adminarea/admin/fillgrid',
            type:'GET'
        }).done(function (data){
            $("#fillgrid").html(data);
            $("#loader").hide();
            ...
            btnedit.on('click', function (e){
                ...
                $.colorbox({
                href:"<?php echo base_url()?>adminarea/admin/edit/"+editid,
                top:50,
                width:500,
